...
#   NET          NNUE net for the candidate       (default: <repo>/nnue/pawnstar-v12.bin)
...
#
# Example:
#   ENGINE=build/pawnstar NET=nnue/pawnstar-v12.bin OPENINGS=~/openings.epd \
#   tools/rate.sh toga:2950:/path/to/togaii senpai:3050:/path/to/senpai
set -uo pipefail

REPO="$(cd "$(dirname "$0")/.." && pwd)"
# build/pawnstar is the stable symlink the build maintains to the latest version-named binary
# (pawnstar_<major>_<minor>_<build>).
