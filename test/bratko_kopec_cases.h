#pragma once
/// @file bratko_kopec_cases.h Bratko-Kopec test positions and their accepted best moves.
///
/// Used by the NNUE suite (test/bratko_kopec_nnue.cpp), which searches each position with the net and
/// checks the *move* (the classic Bratko-Kopec metric — did the engine find a good move). Each case is a
/// position plus up to 5 accepted moves: the set of best moves the engine produces across single-threaded
/// searches at depths 8–11 (the search is deterministic per depth, so this is the union of the four
/// per-depth results). A position is "solved" when the move found is one of these. The suite passes 24/24
/// at every depth 8–11; regenerate the move sets if the net or search changes (see bratko_kopec_nnue.cpp).
...
inline constexpr std::array<BkCase, 24> kCases{{
    ...
    {"3r1k2/4npp1/1ppr3p/p6P/P2PPPP1/1NR5/5K2/2R5 w - -",                  {"f2e3"}},
    ...
    {"1nk1r1r1/pp2n1pp/4p3/q2pPp1N/b1pP1P2/B1P2R2/2P1B1PP/R2Q2K1 w - -",   {"d1c1", "f3g3"}},
    {"4b3/p3kp2/6p1/3pP2p/2pP1P2/4K1P1/P3N2P/8 w - -",                     {"f4f5"}},
    {"2kr1bnr/pbpq4/2n1pp2/3p3p/3P1P1B/2N2N1Q/PPP3PP/2KR1B1R w - -",       {"c1b1", "f1b5"}},
    {"3rr1k1/pp3pp1/1qn2np1/8/3p4/PP1R1P2/2P1NQPP/R1B3K1 b - -",           {"b6c5", "c6e5"}},
