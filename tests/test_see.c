...
static const see_case_t CASES[] = {
    {"1k1r4/1pp4p/p7/4p3/8/P5P1/1PP4P/2K1R3 w - -",
     "e1", "e5", ROOK, PAWN, 100, "rook captures pawn, no defenders"},
    {"1k1r3q/1ppn3p/p4b2/4p3/8/P2N2P1/1PP1R1BP/2K1Q3 w - -",
     "d3", "e5", KNIGHT, PAWN, -200, "knight captures pawn, loses to defenders"},
};
...
int main(void)
{
    ...
    for (int i = 0; i < NUM_CASES; ++i)
    {
        ...
        move_t            m =
            move_capture(square_from_string(tc->from), square_from_string(tc->to), tc->piece, tc->captured);
