...
constexpr PerftTest perft_tests[] = {
    /*    position                                                            depth      nodes   captures      ep
...
*/
static inline void CategorizeMoves(const Position &src_position, const MoveList &move_list, PerftCounts &counts)
{
