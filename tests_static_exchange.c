...
static const SeeTest tests[] = {
    { "1k1r3q/1ppn3p/p4b2/4p3/8/P2N2P1/1PP1R1BP/2K1Q3 w - -", CONSTRUCT_MOVE(D3, E5, KNIGHT, CAPTURE, PAWN) },
    { "1k1r4/1ppn3p/p4b2/4p3/8/P2N2P1/1PP1R1BP/2K1Q3 w - -",  CONSTRUCT_MOVE(D3, E5, KNIGHT, CAPTURE, PAWN) },
    { NULL, },
};
