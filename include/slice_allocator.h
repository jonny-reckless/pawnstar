...
typedef struct
{
    ...
    mtx_t  lock;        ///< Protects free_list and free_count.
} slice_allocator_t;
...
/// @brief Return @p ptr to the pool. @p ptr must be a pointer previously returned by slice_allocator_alloc on this pool.
